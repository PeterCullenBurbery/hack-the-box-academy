...
The `modules/` folder contains modules from "Intro to Academy" to "Advanced Deserialization Attacks".
...
> Peter Cullen Burbery. (2025). Hack the Box modules archive (v2.7.0) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.16645544
